      ...
      <FieldWrapper>
        <Section gap={1}>
          ...
          <InputLayouts.Vertical
            ...
            subDescription="Choose how InovaChat should authenticate with Bedrock."
          >
            <InputSelect
      ...
      {authMethod === AUTH_METHOD_IAM && (
        <FieldWrapper>
          <Card background="none" border="solid" padding="sm">
            <Content
              icon={SvgAlertCircle}
              title="InovaChat will use the IAM role attached to the environment it’s running in to authenticate."
              variant="body"
              sizePreset="main-ui"
            />
          </Card>
