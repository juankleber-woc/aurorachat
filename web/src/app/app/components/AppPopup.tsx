...
export function AppPopup() {
  ...
  // Header icon rules:
  // - If neither app name nor custom logo exists -> show InovaChat icon
  // - If logo display is "name_only" -> show alert icon
  // - Otherwise -> show uploaded custom logo (fallback to InovaChat icon)
  const headerIcon =
  ...
  return (
    <Modal open onOpenChange={() => {}}>
      <Modal.Content width="sm" height="lg">
        <Modal.Header
          icon={headerIcon}
          title={popupTitle || "Welcome to InovaChat!"}
        />
        <Modal.Body>
